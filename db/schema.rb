...
ActiveRecord::Schema[7.1].define(version: 2025_03_10_134430) do
  ...
  create_table "incription_rewards", force: :cascade do |t|
    t.bigint "inscription_id", null: false
    t.bigint "reward_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["inscription_id"], name: "index_incription_rewards_on_inscription_id"
    t.index ["reward_id"], name: "index_incription_rewards_on_reward_id"
  end
  ...
  add_foreign_key "incription_rewards", "inscriptions"
  add_foreign_key "incription_rewards", "rewards"
